...
vi.mock(
  '../src/components/modules/packages/components/ConfigurationTab',
  () => ({
    __esModule: true,
    default: vi.fn(() => null),
  })
...
vi.mock('../src/components/modules/dependency-graph/DependencyGraph', () => ({
  __esModule: true,
  default: vi.fn(() => null),
}));
...
vi.mock('../src/components/publish-control/PublishControl', () => ({
  __esModule: true,
  default: vi.fn(() => null),
}));
...
describe('Dashboard components exist', () => {
  it('ConfigurationTab can be imported', () => {
...
describe('Dashboard components are React components', () => {
  it('components are functions that can be called', () => {
    const components = [
      ConfigurationTab,
      HealthStatus,
      PackagesOverview,
