    ...
    <div className="bg-white rounded-lg shadow p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Review the changeset that will be created. Enter a summary of the
          changes.
        </p>
      </div>
            ...
            >
              <div>
                ...
                <p className="flex items-center gap-2 text-sm text-gray-500">
                  {pkg.currentVersion} <ArrowLongRightIcon></ArrowLongRightIcon>{' '}
                  {pkg.newVersion}
                </p>
              </div>
      ...
      {existingChangesets.length > 0 && (
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          ...
          <p className="text-yellow-700 text-sm mt-1">
            There are {existingChangesets.length} existing unpublished
            changeset(s). Creating new ones will accumulate until published.
          </p>
        </div>
      )}
