    ...
    <div className="bg-white rounded-lg shadow p-6 space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg mb-4">
          Changeset created and publishing workflow started for{' '}
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                A changeset has been created with your release information
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
            ...
            <div>
              <p className="font-medium text-blue-900">
                2. Publishing Workflow Started
              </p>
              <p className="text-sm text-blue-700 mt-1">
                GitHub Actions workflow has been triggered to publish your
                packages
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Check GitHub Actions for the workflow status and npm registry
                for package updates
              </p>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <p className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <ArrowLongRightIcon></ArrowLongRightIcon> v{pkg.newVersion}
                </p>
              </div>
      ...
      <div className="border-t pt-6 flex gap-4 justify-center">
        <a
          href="#"
          className="flex items-center gap-2 gap-2 text-primary-600 hover:text-primary-700 font-medium text-sm"
        >
