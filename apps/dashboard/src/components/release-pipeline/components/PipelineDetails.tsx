        ...
        <div className="flex flex-col gap-2">
          {selectedPipeline.lastRun?.html_url && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 transition hover:border-primary-400 hover:text-primary-700 text-center"
            >
              Open in GitHub
            </a>
          )}
          {hasPermission('maintain') && (
            <div className="flex gap-3">
              <button
                type="button"
                disabled={
                  actionLoading === 'rerun' || !selectedPipeline.lastRun
                }
